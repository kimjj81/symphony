...
12. If this item is a GitHub issue in Planned, do not implement in the issue lane. Create or reuse a PR without creating a source-issue worktree, label the PR Planned for implementation, then move the source issue to Human Review.
